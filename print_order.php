...
<html>
  ...
  <body background="bg1.jpg">
    ...
    <tr height="25">
      <td colspan="4">電話：
        <u><?php echo $_COOKIE["telephone"]; for ($i = 0; $i <= 100 - 2* strlen($_COOKIE["telephone"]); $i++) echo "&nbsp;"; ?></u>
      </td>
    </tr>
    <tr height="25">
      <td colspan="4">地址：
        <u><?php echo $_COOKIE["address"]; for ($i = 0; $i <= 100 - 2* strlen($_COOKIE["address"]); $i++) echo "&nbsp;"; ?></u>
      </td>
    </tr>
    <tr height="25">
      <td colspan="4">
